...
if os.path.exists(os.path.join("models", "SVM.sav")) and force_retrain == None:
    clf = pickle.load(open(os.path.join("models", "C:\\Users\\Hp\\Desktop\\fake review\\models\\SVM.sav"), "rb"))
    y_pred_svc = pickle.load(open(os.path.join("models", "C:\\Users\\Hp\\Desktop\\fake review\\models\\SVM_y_pred.sav"), "rb"))
